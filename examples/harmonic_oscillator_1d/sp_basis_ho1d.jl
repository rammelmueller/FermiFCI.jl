...
function (orb::HOOrbital1D)(x::Number, b::Number=1)::Float64
    ...
    """
    Float64((b^2/pi)^0.25 / sqrt(big(2.0^orb.n * factorial(big(orb.n)))) * exp(-0.5*b^2*x^2) * basis(Hermite, Int64(orb.n))(x))
end
